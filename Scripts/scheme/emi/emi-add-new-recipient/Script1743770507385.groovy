...
WebUI.navigateToUrl('https://demo.app.vestd.com/company/50934/reward-template/40375')
...
not_run: WebUI.click(findTestObject('Object Repository/schemes/emi/add-new-recipient/div_Back to list of templates              _8d0153'))
...
not_run: WebUI.verifyElementText(findTestObject('Object Repository/schemes/emi/add-new-recipient/td_Test Recipient option draft'), 
    'Test Recipient option draft')
...
WebUI.verifyElementNotPresent(findTestObject('Object Repository/schemes/emi/add-new-recipient/td_Ordinary'), 0)

not_run: WebUI.verifyElementNotVisible(findTestObject('Object Repository/schemes/emi/add-new-recipient/td_1,000'))

WebUI.verifyElementNotPresent(findTestObject('Object Repository/schemes/emi/add-new-recipient/td_1,000'), 0)
...
WebUI.verifyElementNotPresent(findTestObject('Object Repository/schemes/emi/add-new-recipient/td_No'), 0)

not_run: WebUI.verifyElementNotVisible(findTestObject('Object Repository/schemes/emi/add-new-recipient/td_No_1'))

WebUI.verifyElementNotPresent(findTestObject('Object Repository/schemes/emi/add-new-recipient/td_No_1'), 0)

WebUI.waitForElementNotPresent(findTestObject('Object Repository/schemes/emi/add-new-recipient/td_Edit'), 0)
