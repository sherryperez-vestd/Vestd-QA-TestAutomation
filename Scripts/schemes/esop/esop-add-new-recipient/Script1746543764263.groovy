...
WebUI.selectOptionByValue(findTestObject('Object Repository/schemes/emi/add-new-recipient/select_Please select oneOption pool 1'), 
    '167068', true)
...
WebUI.verifyElementPresent(findTestObject('Object Repository/schemes/emi/add-new-recipient/td_Test Recipient'), 
    0)

not_run: WebUI.verifyElementText(findTestObject('Object Repository/schemes/emi/add-new-recipient/td_Test Recipient'), 
    'Test Recipient\n \n Not invited')
...
WebUI.verifyElementNotPresent(findTestObject('Object Repository/schemes/emi/add-new-recipient/td_Test Recipient'), 
    0)
