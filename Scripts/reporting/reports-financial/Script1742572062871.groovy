...
WebUI.verifyElementPresent(findTestObject('StatSquad/reporting/financial/text_Information provided in the report'), 0)

WebUI.verifyElementText(findTestObject('StatSquad/reporting/financial/text_Information provided in the report'), 'Information provided in the report:')
...
WebUI.verifyElementText(findTestObject('StatSquad/reporting/financial/list-text_Options Lapsed'), 'Options Lapsed: View all options that lapsed during the period.')

WebUI.verifyElementPresent(findTestObject('StatSquad/reporting/financial/list-text_Options Exercised'), 0)

WebUI.verifyElementText(findTestObject('StatSquad/reporting/financial/list-text_Options Exercised'), 'Options Exercised: See all options that were exercised during the period.')

WebUI.verifyElementPresent(findTestObject('StatSquad/reporting/financial/list-text_Reverse Vesting'), 0)

WebUI.verifyElementText(findTestObject('StatSquad/reporting/financial/list-text_Reverse Vesting'), 'Reverse Vesting: List any reverse vesting events within the date range.')

WebUI.verifyElementPresent(findTestObject('StatSquad/reporting/financial/list-text_Leavers Processed'), 0)

WebUI.verifyElementText(findTestObject('StatSquad/reporting/financial/list-text_Leavers Processed'), 'Leavers Processed: Review leavers whose options were processed during the selected period.')

WebUI.verifyElementPresent(findTestObject('StatSquad/reporting/financial/list-text_Exercise Requests'), 0)

WebUI.verifyElementText(findTestObject('StatSquad/reporting/financial/list-text_Exercise Requests'), 'Exercise Requests: Track all exercise requests made within the time frame.')

WebUI.verifyElementPresent(findTestObject('StatSquad/reporting/financial/text_Once the date range is selected'), 0)

WebUI.verifyElementText(findTestObject('StatSquad/reporting/financial/text_Once the date range is selected'), 'Once the date range is selected, click the corresponding download button to generate and download the report in Excel (xslx) format.')
...
WebUI.verifyElementPresent(findTestObject('StatSquad/reporting/financial/input_Day_from_date_day'), 0)

WebUI.verifyElementPresent(findTestObject('StatSquad/reporting/financial/input_Month_from_date_month'), 0)

WebUI.verifyElementPresent(findTestObject('StatSquad/reporting/financial/input_Year_from_date_year'), 0)
...
WebUI.verifyElementPresent(findTestObject('StatSquad/reporting/financial/input_Day_to_date_day'), 0)

WebUI.verifyElementPresent(findTestObject('StatSquad/reporting/financial/input_Month_to_date_month'), 0)

WebUI.verifyElementPresent(findTestObject('StatSquad/reporting/financial/input_Year_to_date_year'), 0)

WebUI.verifyElementPresent(findTestObject('StatSquad/reporting/financial/label_Fetch records from this date'), 0)
...
WebUI.verifyElementText(findTestObject('StatSquad/reporting/financial/label-validation-message_The to date must be a date after or equal'), 
    'The to date must be a date after or equal to from date.')
