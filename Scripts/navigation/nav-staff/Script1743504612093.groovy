...
WebUI.verifyElementPresent(findTestObject('navigation/Share schemes/Page_RSA/a_RSAs'), 0)

WebUI.verifyElementText(findTestObject('navigation/Share schemes/Page_RSA/a_RSAs'), 'RSAs')

WebUI.click(findTestObject('navigation/Share schemes/Page_RSA/a_RSAs'))

WebUI.verifyElementPresent(findTestObject('navigation/Share schemes/Page_RSA/h1_RSAs'), 0)

WebUI.verifyElementText(findTestObject('navigation/Share schemes/Page_RSA/h1_RSAs'), 'RSAs')
