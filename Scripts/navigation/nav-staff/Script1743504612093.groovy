...
WebUI.verifyElementVisible(findTestObject('Object Repository/users/home-page/a_Staff'))

WebUI.verifyElementPresent(findTestObject('Object Repository/users/home-page/a_Staff'), 0)

WebUI.verifyElementText(findTestObject('Object Repository/users/home-page/a_Staff'), 'Staff')

not_run: WebUI.verifyElementVisible(findTestObject('Object Repository/users/home-page/a_Company - staff'))

WebUI.verifyElementPresent(findTestObject('Object Repository/users/home-page/a_Company - staff'), 
    0)

WebUI.verifyElementText(findTestObject('Object Repository/users/home-page/a_Company - staff'), 
    'Company - staff')

WebUI.verifyElementVisible(findTestObject('Object Repository/users/home-page/a_App - staff'))

WebUI.verifyElementPresent(findTestObject('Object Repository/users/home-page/a_App - staff'), 0)

WebUI.verifyElementText(findTestObject('Object Repository/users/home-page/a_App - staff'), 'App - staff')
