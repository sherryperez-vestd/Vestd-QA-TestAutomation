...
WebUI.callTestCase(findTestCase('users-login/UK/user-login-view-only'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Object Repository/users/dashboard/a_View'))

not_run: WebUI.verifyElementNotVisibleInViewport(findTestObject('Object Repository/users/home-page/a_Staff'), 0)

not_run: WebUI.verifyElementNotPresent(findTestObject('Object Repository/users/home-page/a_Staff'), 0)
...
WebUI.verifyElementNotPresent(findTestObject('Object Repository/users/home-page/a_Company - staff'), 0)

not_run: WebUI.verifyElementText(findTestObject('Object Repository/users/home-page/a_Company - staff'), 'Company - staff')

not_run: WebUI.verifyElementNotVisible(findTestObject('Object Repository/users/home-page/a_App - staff'))

WebUI.verifyElementNotPresent(findTestObject('Object Repository/users/home-page/a_App - staff'), 0)

not_run: WebUI.verifyElementText(findTestObject('Object Repository/users/home-page/a_App - staff'), 'App - staff')
...
WebUI.verifyElementPresent(findTestObject('Object Repository/users/home-page/a_Share schemes'), 0)
...
WebUI.verifyElementPresent(findTestObject('Object Repository/users/home-page/a_Share capital'), 0)
...
WebUI.verifyElementPresent(findTestObject('Object Repository/users/home-page/a_Secretarial  admin'), 0)

WebUI.verifyElementText(findTestObject('Object Repository/users/home-page/a_Secretarial  admin'), 'Secretarial & admin')

WebUI.verifyElementVisible(findTestObject('Object Repository/users/home-page/a_People  communication'))

WebUI.verifyElementPresent(findTestObject('Object Repository/users/home-page/a_People  communication'), 0)

WebUI.verifyElementText(findTestObject('Object Repository/users/home-page/a_People  communication'), 'People & communication')

WebUI.verifyElementVisible(findTestObject('Object Repository/users/home-page/a_Help Centre'))

WebUI.verifyElementPresent(findTestObject('Object Repository/users/home-page/a_Help Centre_1'), 0)
...
WebUI.verifyElementPresent(findTestObject('Object Repository/users/home-page/a_Company settings'), 0)

WebUI.verifyElementText(findTestObject('Object Repository/users/home-page/a_Company settings'), 'Company settings')
