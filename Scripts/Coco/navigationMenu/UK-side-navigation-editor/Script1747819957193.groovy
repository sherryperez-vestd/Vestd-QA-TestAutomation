...
WebUI.verifyElementNotPresent(findTestObject('navigation/side-nav/a_My equity'), 0)
...
WebUI.verifyElementNotPresent(findTestObject('navigation/side-nav/Share schemes/Page_RSA/a_RSAs'), 0)
...
WebUI.verifyElementText(findTestObject('navigation/side-nav/Investment/Page_Guided-Flow/h1_Investment via InVestd - Invested Raise'), 
