...
WebUI.verifyElementPresent(findTestObject('Object Repository/users/dashboard/Page_Dashboard/h1_Dashboard'), 0)

WebUI.waitForElementVisible(findTestObject('Object Repository/users/dashboard/Page_Dashboard/h1_Dashboard'), 0)
...
WebUI.verifyElementClickable(findTestObject('Object Repository/users/dashboard/Page_Dashboard/a_Potential profit graph'))
...
WebUI.verifyElementText(findTestObject('Object Repository/users/dashboard/Page_Dashboard/a_Ask a company to add you'), 'Ask a company to add you')

WebUI.verifyElementClickable(findTestObject('Object Repository/users/dashboard/Page_Dashboard/a_Ask a company to add you'))

WebUI.click(findTestObject('Object Repository/users/dashboard/Page_Dashboard/a_Ask a company to add you'))
...
WebUI.verifyElementText(findTestObject('Object Repository/users/dashboard/Page_Dashboard/a_Invite a company to join'), 'Invite a company to join')

WebUI.click(findTestObject('Object Repository/users/dashboard/Page_Dashboard/a_Invite a company to join'))

WebUI.verifyElementPresent(findTestObject('users/dashboard/Page_Request_access-Invite to company/h1_Invite a company'), 0)
...
WebUI.verifyElementText(findTestObject('Object Repository/users/dashboard/Page_Dashboard/a_Onboard a company'), 'Onboard a company')

WebUI.click(findTestObject('Object Repository/users/dashboard/Page_Dashboard/a_Onboard a company'))

WebUI.verifyElementPresent(findTestObject('Object Repository/users/dashboard/Page_Get started/h1_Get started'), 0)

WebUI.verifyElementVisible(findTestObject('Object Repository/users/dashboard/Page_Get started/h1_Get started'))

WebUI.verifyElementText(findTestObject('Object Repository/users/dashboard/Page_Get started/h1_Get started'), 'Get started')
...
WebUI.verifyElementText(findTestObject('Object Repository/users/dashboard/Page_Dashboard/a_Incorporate a company'), 'Incorporate a company')

WebUI.click(findTestObject('Object Repository/users/dashboard/Page_Dashboard/a_Incorporate a company'))

WebUI.verifyElementPresent(findTestObject('Object Repository/users/dashboard/Page_Get started/a_Join Essentials'), 0)

WebUI.verifyElementPresent(findTestObject('Object Repository/users/dashboard/Page_Get started/a_Continue to plans'), 0)
...
WebUI.verifyElementText(findTestObject('Object Repository/users/dashboard/Page_Dashboard/a_Record an investment'), 'Record an investment')
...
WebUI.click(findTestObject('Object Repository/users/dashboard/Page_Dashboard/button_Customise'))

WebUI.verifyElementPresent(findTestObject('Object Repository/users/dashboard/Page_Group/h1_Customise dashboard'), 0)

WebUI.verifyElementVisible(findTestObject('Object Repository/users/dashboard/Page_Group/h1_Customise dashboard'))

WebUI.verifyElementVisible(findTestObject('Object Repository/users/dashboard/Page_Group/button_New group'))

WebUI.verifyElementPresent(findTestObject('Object Repository/users/dashboard/Page_Group/button_New group'), 0)

WebUI.verifyElementText(findTestObject('Object Repository/users/dashboard/Page_Group/button_New group'), 'New group')

WebUI.click(findTestObject('Object Repository/users/dashboard/Page_Group/button_New group'))

WebUI.setText(findTestObject('Object Repository/users/dashboard/Page_Group - Create/input_Group name'), 'test')
...
WebUI.verifyElementPresent(findTestObject('Object Repository/users/dashboard/Page_Group/h5_test'), 0)

WebUI.verifyElementText(findTestObject('Object Repository/users/dashboard/Page_Group/h5_test'), 'test')

WebUI.click(findTestObject('Object Repository/users/dashboard/Page_Group/button_Delete'))

WebUI.click(findTestObject('Object Repository/users/dashboard/Page_Group/button_Yes, delete this group'))
