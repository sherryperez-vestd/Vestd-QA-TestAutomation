...
WebUI.verifyElementPresent(findTestObject('myEquity/show-hide-settings/label_Hide My Equity calculator and graph2'), 0)
...
WebUI.verifyElementPresent(findTestObject('Object Repository/myEquity/show-hide-settings/div_Yes, hide the value graph and the calculator'), 0)
WebUI.verifyElementPresent(findTestObject('Object Repository/myEquity/show-hide-settings/input_Hide My Equity calculator and graph'), 0)
WebUI.verifyElementPresent(findTestObject('Object Repository/myEquity/show-hide-settings/label_Yes, hide the value graph and the calculator'),  0)
...
WebUI.verifyElementPresent(findTestObject('Object Repository/myEquity/show-hide-settings/input_No show the value graph and the calculator'), 0)
WebUI.verifyElementPresent(findTestObject('Object Repository/myEquity/show-hide-settings/label_No, show the value graph and calculator'), 0)
...
WebUI.verifyElementPresent(findTestObject('Object Repository/myEquity/show-hide-settings/message_Company updated'), 0)
...
WebUI.verifyElementPresent(findTestObject('Object Repository/myEquity/show-hide-settings/tab_Overall value'), 0)
WebUI.verifyElementPresent(findTestObject('Object Repository/myEquity/show-hide-settings/div_Estimated Profit in 5 Years Annual grow_898f9a'), 0)
// WebUI.verifyElementVisible(findTestObject('Object Repository/myEquity/show-hide-settings/div_Estimated Profit in 5 Years Annual grow_898f9a'))
WebUI.navigateToUrl('https://demo.app.vestd.com/company/50135/admin')
...
WebUI.navigateToUrl('https://demo.app.vestd.com/company/50135/admin')
WebUI.click(findTestObject('myEquity/show-hide-settings/input_No show the value graph and the calculator'))
WebUI.click(findTestObject('Object Repository/myEquity/show-hide-settings/button_Save'))
