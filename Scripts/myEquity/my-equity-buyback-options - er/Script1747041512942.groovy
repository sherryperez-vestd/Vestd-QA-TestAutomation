...
WebUI.waitForElementVisible(findTestObject('myEquity/shares-options-breakdown/options-breakdown/li_Buyback tooltip text'), 
    2)

'Check Buyback tooltip info text is displayed'
WebUI.verifyElementVisible(findTestObject('myEquity/shares-options-breakdown/options-breakdown/li_Buyback tooltip text'), 
