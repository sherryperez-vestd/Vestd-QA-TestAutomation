...
WebUI.verifyElementText(findTestObject('Object Repository/StatSquad/myEquity/unknown-cost/txt_unknown-cost-lead-text'), 'We don’t have a record of how much you paid for these shareholdings, so we’ve defaulted to nominal value. Update the price you paid for these shares to see your actual profit.')
...
WebUI.verifyElementText(findTestObject('Object Repository/StatSquad/myEquity/unknown-cost/small_0.0001 nominal value'), '£0.0001 nominal value')
WebUI.verifyElementPresent(findTestObject('Object Repository/StatSquad/myEquity/unknown-cost/small_shares_date_issued'), 0)
