...
WebUI.setText(findTestObject('Object Repository/myEquity/cancelled-deferred/cancel-agreement-page/input_Number to cancel_number_to_cancel'), 
    '40')
...
WebUI.setText(findTestObject('Object Repository/myEquity/cancelled-deferred/cancel-agreement-page/textarea_Additional notes_reason'), 
    'x')
