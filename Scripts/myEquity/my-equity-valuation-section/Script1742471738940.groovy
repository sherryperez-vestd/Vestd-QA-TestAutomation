...
WebUI.verifyElementNotVisible(findTestObject('myEquity/valuation-section/btn_See_more'))
...
WebUI.verifyElementPresent(findTestObject('myEquity/valuation-section/button-cancel_Company-valuation-history-modal'), 
    0)
...
not_run: WebUI.verifyElementText(findTestObject('myEquity/valuation-section/tooltip-txt_Company-valuation-history'), 
