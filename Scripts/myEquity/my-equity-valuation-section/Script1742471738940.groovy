...
WebUI.verifyElementVisible(findTestObject('Object Repository/my-equity-page/valuation-section/tile_1Company-valuation-history'))

WebUI.verifyElementVisible(findTestObject('Object Repository/my-equity-page/valuation-section/tile_Current-valuation'))
...
'Check See more link'
WebUI.verifyElementText(findTestObject('Object Repository/my-equity-page/valuation-section/btn_See_more'), 'See more')

WebUI.click(findTestObject('my-equity-page/valuation-section/btn_See_more'))

'Check Current valuation history Cancel CTA'
WebUI.verifyElementPresent(findTestObject('my-equity-page/valuation-section/button-cancel_Company-valuation-history-modal'), 
    0)
