...
// WebUI.verifyElementPresent(findTestObject('Object Repository/myEquity/valuation-section/tile_2Company-valuation-history'), 0)
...
// WebUI.verifyElementPresent(findTestObject('Object Repository/myEquity/valuation-section/tooltip-icon_Current-valuation'), 0)
//WebUI.mouseOver(findTestObject('Object Repository/myEquity/valuation-section/tooltip-icon_Current-valuation'))
// WebUI.click(findTestObject('Object Repository/myEquity/valuation-section/tooltip-icon_Current-valuation'))

// WebUI.verifyElementText(findTestObject('Object Repository/myEquity/valuation-section/tooltip-txt_Current-valuation'), 'This valuation was added by the company on 10th January 2025.')

'Check Company valuation history tooltip'
// WebUI.click(findTestObject('myEquity/valuation-section/tooltip-icon_Current-valuation'))

'Check Company valuation history tooltip'
// WebUI.click(findTestObject('Object Repository/myEquity/valuation-section/tooltip-icon_Company-valuation-history'))
// WebUI.verifyElementPresent(findTestObject('Object Repository/myEquity/valuation-section/tooltip-icon_Company-valuation-history'), 0)
// WebUI.verifyElementVisible(findTestObject('Object Repository/myEquity/valuation-section/tooltip-txt_Company-valuation-history'))
// WebUI.verifyElementText(findTestObject('myEquity/valuation-section/tooltip-txt_Company-valuation-history'), 'Keep in mind that adjusting the company valuation toggle will instantly update the figures displayed on the graph')
