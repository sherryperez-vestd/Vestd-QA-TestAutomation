...
WebUI.verifyElementPresent(findTestObject('Object Repository/myEquity/award-section/tooltip-icon_award-pre-tax-profit'), 
    0)
...
WebUI.verifyElementPresent(findTestObject('Object Repository/myEquity/award-section/tooltip-text_award-pre-tax-profit'), 
    0)
