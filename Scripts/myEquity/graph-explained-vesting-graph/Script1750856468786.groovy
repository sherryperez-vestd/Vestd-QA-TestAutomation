...
WebUI.verifyElementPresent(findTestObject('Object Repository/StatSquad/myEquity/vesting-schedule_graph-explained/span_Your vesting schedule'), 
    0)
...
WebUI.verifyElementVisible(findTestObject('Object Repository/StatSquad/myEquity/vesting-schedule_graph-explained/h5_Full schedule (49 tranches)'))

WebUI.verifyElementPresent(findTestObject('Object Repository/StatSquad/myEquity/vesting-schedule_graph-explained/div_Your vesting schedule Full schedule'), 
    0)
...
WebUI.verifyElementPresent(findTestObject('Object Repository/StatSquad/myEquity/vesting-schedule_graph-explained/th_Vesting period'), 
    0)

WebUI.verifyElementText(findTestObject('Object Repository/StatSquad/myEquity/vesting-schedule_graph-explained/th_Vesting period'), 
    'Vesting period')

WebUI.click(findTestObject('Object Repository/StatSquad/myEquity/vesting-schedule_graph-explained/th_Number of shares'))

WebUI.verifyElementPresent(findTestObject('Object Repository/StatSquad/myEquity/vesting-schedule_graph-explained/th_Number of shares'), 
    0)

WebUI.verifyElementText(findTestObject('Object Repository/StatSquad/myEquity/vesting-schedule_graph-explained/th_Number of shares'), 
    'Number of shares')

WebUI.verifyElementPresent(findTestObject('Object Repository/StatSquad/myEquity/vesting-schedule_graph-explained/th_Agreement name'), 
    0)
...
not_run: WebUI.verifyElementText(findTestObject('Object Repository/StatSquad/myEquity/vesting-schedule_graph-explained/txt_Watch your share value grow'), 
    'Watch your share value grow!')

WebUI.verifyElementPresent(findTestObject('Object Repository/StatSquad/myEquity/vesting-schedule_graph-explained/txt_hurdle-message'), 
    0)
