...
CustomKeywords.'UIKeywords.verifyElementPresentVisible'('Platform/register/Page_Register-new-user/a_Join now')
CustomKeywords.'UIKeywords.verifyElementPresentVisible'('Platform/register/Page_Register-new-user/a_StartUKDemo')
CustomKeywords.'UIKeywords.verifyElementPresentVisible'('Platform/register/Page_Register-new-user/a_StartIndiaDemo')

WebUI.click(findTestObject('Object Repository/Platform/register/Page_Register-new-user/a_Join now'))

WebUI.setText(findTestObject('Object Repository/Platform/register/Page_Register-new-user/input_First name_given_name'), 'test')

WebUI.click(findTestObject('Object Repository/Platform/register/Page_Register-new-user/div_Last name'))

WebUI.setText(findTestObject('Object Repository/Platform/register/Page_Register-new-user/input_Last name_family_name'), 'new')

WebUI.setText(findTestObject('Object Repository/Platform/register/Page_Register-new-user/input_Email address_email'), 'sherry.perez+new@vestd.com')
...
CustomKeywords.'UIKeywords.verifyElementPresentVisibleText'('Platform/register/Page_Verify email - Vestd/div_You should have received a verification',  'You should have received a verification email to the address provided below. Please follow the link to verify your email.')
