...
WebUI.verifyElementPresent(findTestObject('StatSquad/myEquity/showHideDilutedToggle/radio_Show diluted numbers Yes'), 
    0)

WebUI.verifyElementPresent(findTestObject('StatSquad/myEquity/showHideDilutedToggle/label_Show diluted No'), 0)

WebUI.verifyElementPresent(findTestObject('StatSquad/myEquity/showHideDilutedToggle/radio_Show diluted numbers No'), 
    0)

WebUI.verifyElementChecked(findTestObject('StatSquad/myEquity/showHideDilutedToggle/radio_Show diluted numbers Yes'), 
    10)
