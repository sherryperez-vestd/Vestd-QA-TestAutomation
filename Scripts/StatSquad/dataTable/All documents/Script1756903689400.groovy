...
//verifyDropdownFilter('allDocuments/div_Status', ['label_active', 'label_inactive'])
//
//verifyDropdownFilter('allDocuments/div_Document Type', ['label_individual', 'label_corporate'])
//
//verifyDropdownFilter('allDocuments/div_Companies House', ['label_invited', 'label_notInvited'])
...
WebUI.verifyTextPresent('109 entries', true)
