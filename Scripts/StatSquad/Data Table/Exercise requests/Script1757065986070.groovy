...
// ------------------  EMI  ----------------------------
WebUI.navigateToUrl('https://demo.app.vestd.com/company/50934/option/exercise?page=1&per_page=25')
...
def headersToCheck = ['Option', 'Scheme', 'Recipient', 'Status', 'Number of shares', 'Date completed']
...
//verifyDropdownFilter('exerciseRequests/div_Scheme type', ['label_EMI','label_Unapproved','label_Growth Shares', 'label_ESOP', 'label_Conditional Shares', 'label_CSOP', 'label_Phantom', 'label_RSA','label_Ordinary Shares'])
verifyDropdownFilter('exerciseRequests/div_Status', ['label_Reversed', 'label_Complete', 'label_readyToComplete', 'label_waitingForTheRecipient'])
...
CustomKeywords.'UIKeywords.clickElement'('Object Repository/StatSquad/dataTable/exerciseRequests/div_Scheme type')

CustomKeywords.'UIKeywords.clickElement'('Object Repository/StatSquad/dataTable/exerciseRequests/label_CSOP')

CustomKeywords.'UIKeywords.verifyElementPresentVisible'('Object Repository/StatSquad/dataTable/td_noRecordsFound')

WebUI.click(findTestObject('StatSquad/dataTable/div_xClearFilter'))

WebUI.verifyTextPresent('2 entries', true) // Verify header text
...
def verifyDropdownFilter(String dropdownPath, List<String> labelList) {
    ...
    labelList.each({ 
            CustomKeywords.'UIKeywords.verifyElementPresentVisible'("Object Repository/StatSquad/dataTable/exerciseRequests/$it")
        })
}
