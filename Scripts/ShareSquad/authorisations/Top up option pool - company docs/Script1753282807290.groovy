...
WebUI.navigateToUrl('https://demo.app.vestd.com/company/50934/share-approval/176208')
...
WebUI.click(findTestObject('ShareSquad/authorisations/Top up pool/radio_DR-select-docs'))

WebUI.selectOptionByValue(findTestObject('ShareSquad/authorisations/Top up pool/select_DR-companydocs'), '567737', true)

WebUI.click(findTestObject('ShareSquad/authorisations/Top up pool/radio_SH-select-docs'))

WebUI.selectOptionByValue(findTestObject('ShareSquad/authorisations/Top up pool/select_SH-companydocs'), '568418', true)
