...
WebUI.verifyElementPresent(findTestObject('authorisations/Page_Create Confirm details/h1_Test'), 0)

WebUI.verifyElementVisible(findTestObject('authorisations/Page_Create Confirm details/h1_Test'))
