...
WebUI.waitForElementPresent(findTestObject('ShareSquad/issueShares/share-distribution-create/select_share Authorisation'), 
    0)

WebUI.click(findTestObject('ShareSquad/issueShares/share-distribution-create/select_share Authorisation'))
...
WebUI.scrollToElement(findTestObject('ShareSquad/issueShares/share-distribution-create/input_Number of shares_num_shares'), 
    0)
