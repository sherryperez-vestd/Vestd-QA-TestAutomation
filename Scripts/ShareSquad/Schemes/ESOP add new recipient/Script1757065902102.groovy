...
WebUI.click(findTestObject('ShareSquad/schemes/emi/add-new-recipient/select_Option-pool2'))

WebUI.click(findTestObject('ShareSquad/schemes/emi/add-new-recipient/li_Option pool1'))
...
WebUI.setText(findTestObject('ShareSquad/schemes/emi/add-new-recipient/input_Number of shares'), '1000')

WebUI.click(findTestObject('ShareSquad/schemes/emi/add-new-recipient/select_Country'))

WebUI.click(findTestObject('ShareSquad/schemes/emi/add-new-recipient/li_CountryIN'))

WebUI.setText(findTestObject('ShareSquad/schemes/emi/add-new-recipient/input_Tax-number'), 'AFZPK7190K')
...
not_run: WebUI.verifyElementText(findTestObject('Object Repository/ShareSquad/schemes/emi/add-new-recipient/td_Test Recipient Draft'), 'Test Recipient\n \n Not invited')
