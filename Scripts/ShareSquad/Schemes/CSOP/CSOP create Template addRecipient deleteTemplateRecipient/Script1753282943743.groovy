...
WebUI.navigateToUrl('https://demo.app.vestd.com/company/50934/scheme-template/create?type=csop')
...
//WebUI.selectOptionByValue(findTestObject('Object Repository/ShareSquad/schemes/emi/scheme-template/Page_scheme-design-template/select_Time-based-vesting'), '0', true)
//'Grant dates'
//WebUI.selectOptionByValue(findTestObject('Object Repository/ShareSquad/schemes/emi/scheme-template/Page_scheme-design-template/select_Grant date'), '1', true)
'Leaver clause'
...
WebUI.callTestCase(findTestCase('ShareSquad/Schemes/CSOP/CSOP add new recipient'), [:], FailureHandling.STOP_ON_FAILURE)

'Delete created csop template'
WebUI.navigateToUrl('https://demo.app.vestd.com/company/50934/scheme-template/csop/index')
