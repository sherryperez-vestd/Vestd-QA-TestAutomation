...
WebUI.setText(findTestObject('schemes/emi/scheme-template/Page_scheme-design-template/textarea_Criteria_criteria'), 'x')

'Leaver clause'
WebUI.selectOptionByValue(findTestObject('schemes/emi/scheme-template/Page_scheme-design-template/select_Leaver-condition2'), 
    'discretion', true)
