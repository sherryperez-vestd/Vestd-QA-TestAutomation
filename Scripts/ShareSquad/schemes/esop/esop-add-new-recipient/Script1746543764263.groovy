...
WebUI.click(findTestObject('schemes/emi/add-new-recipient/select_Option-pool2'))

WebUI.click(findTestObject('schemes/emi/add-new-recipient/li_Option pool1'))

WebUI.setText(findTestObject('Object Repository/schemes/emi/add-new-recipient/input_Day'), '1')

WebUI.setText(findTestObject('Object Repository/schemes/emi/add-new-recipient/input_Month'), '1')

WebUI.setText(findTestObject('Object Repository/schemes/emi/add-new-recipient/input_Year'), '2024')
...
WebUI.setText(findTestObject('schemes/emi/add-new-recipient/input_Number of shares'), '1000')

WebUI.click(findTestObject('schemes/emi/add-new-recipient/select_Country'))

WebUI.click(findTestObject('schemes/emi/add-new-recipient/li_CountryIN'))

WebUI.setText(findTestObject('schemes/emi/add-new-recipient/input_Tax-number'), 'AFZPK7190K')

WebUI.click(findTestObject('Object Repository/schemes/emi/add-new-recipient/button_Save as draft and add another'))

WebUI.verifyElementVisible(findTestObject('Object Repository/schemes/emi/add-new-recipient/td_Test Recipient'))

WebUI.verifyElementPresent(findTestObject('Object Repository/schemes/emi/add-new-recipient/td_Test Recipient'), 0)

WebUI.verifyElementVisible(findTestObject('Object Repository/schemes/emi/add-new-recipient/td_Test Recipient Draft'))

WebUI.verifyElementPresent(findTestObject('Object Repository/schemes/emi/add-new-recipient/td_Test Recipient Draft'), 0)

not_run: WebUI.verifyElementText(findTestObject('Object Repository/schemes/emi/add-new-recipient/td_Test Recipient Draft'), 'Test Recipient\n \n Not invited')
...
not_run: WebUI.verifyElementNotVisible(findTestObject('Object Repository/schemes/emi/add-new-recipient/td_Test Recipient'))

not_run: WebUI.verifyElementNotVisible(findTestObject('Object Repository/schemes/emi/add-new-recipient/td_Test Recipient Draft'))
