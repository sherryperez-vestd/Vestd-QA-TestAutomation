...
WebUI.selectOptionByValue(findTestObject('Object Repository/schemes/emi/add-new-recipient/select_Option pool'), '167068', 
    true)
...
WebUI.setText(findTestObject('Object Repository/schemes/emi/add-new-recipient/input_Number of options'), '1000')
...
not_run: WebUI.verifyElementText(findTestObject('Object Repository/schemes/emi/add-new-recipient/td_Test Recipient Draft'), 
    'Test Recipient\n \n Not invited')
...
WebUI.verifyElementNotPresent(findTestObject('Object Repository/schemes/emi/add-new-recipient/td_Test Recipient'), 0)
