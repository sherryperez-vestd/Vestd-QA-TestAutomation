...
WebUI.verifyElementPresent(findTestObject('navigation/side-nav/Page_Home/h1_Reid Ltd'), 0)

WebUI.verifyElementText(findTestObject('navigation/side-nav/Page_Home/h1_Reid Ltd'), 'Reid Ltd')
...
WebUI.verifyElementPresent(findTestObject('navigation/side-nav/Share schemes/Page_ESU/a_Existing scheme uploads'), 0)

WebUI.verifyElementText(findTestObject('navigation/side-nav/Share schemes/Page_ESU/a_Existing scheme uploads'), 'Existing scheme uploads')

WebUI.click(findTestObject('navigation/side-nav/Share schemes/Page_ESU/a_Existing scheme uploads'))

WebUI.verifyElementPresent(findTestObject('navigation/side-nav/Share schemes/Page_ESU/h1_Existing scheme uploads'), 0)

WebUI.verifyElementText(findTestObject('navigation/side-nav/Share schemes/Page_ESU/h1_Existing scheme uploads'), 'Existing scheme uploads')

WebUI.verifyElementPresent(findTestObject('navigation/side-nav/Share schemes/Page_EMI/a_EMI'), 0)

WebUI.verifyElementText(findTestObject('navigation/side-nav/Share schemes/Page_EMI/a_EMI'), 'EMI')

WebUI.click(findTestObject('navigation/side-nav/Share schemes/Page_EMI/a_EMI'))

WebUI.verifyElementPresent(findTestObject('navigation/side-nav/Share schemes/Page_EMI/h1_EMI'), 0)
...
WebUI.verifyElementText(findTestObject('navigation/side-nav/Share schemes/Page_CSOP/a_CSOP'), 'CSOP')

WebUI.click(findTestObject('navigation/side-nav/Share schemes/Page_CSOP/a_CSOP'))

WebUI.verifyElementPresent(findTestObject('navigation/side-nav/Share schemes/Page_CSOP/h1_CSOP'), 0)

WebUI.verifyElementText(findTestObject('navigation/side-nav/Share schemes/Page_CSOP/h1_CSOP'), 'CSOP')

WebUI.verifyElementPresent(findTestObject('navigation/side-nav/Share schemes/Page_Phantom/a_Phantom shares'), 0)

WebUI.verifyElementText(findTestObject('navigation/side-nav/Share schemes/Page_Phantom/a_Phantom shares'), 'Phantom shares')

WebUI.click(findTestObject('navigation/side-nav/Share schemes/Page_Phantom/a_Phantom shares'))

WebUI.verifyElementPresent(findTestObject('navigation/side-nav/Share schemes/Page_Phantom/h1_Phantom'), 0)

WebUI.verifyElementText(findTestObject('navigation/side-nav/Share schemes/Page_Phantom/h1_Phantom'), 'Phantom')
...
WebUI.verifyElementPresent(findTestObject('navigation/side-nav/Share schemes/Page_GS/a_Growth shares'), 0)

WebUI.verifyElementText(findTestObject('navigation/side-nav/Share schemes/Page_GS/a_Growth shares'), 'Growth shares')

WebUI.click(findTestObject('navigation/side-nav/Share schemes/Page_GS/a_Growth shares'))

WebUI.verifyElementPresent(findTestObject('navigation/side-nav/Share schemes/Page_GS/h1_Growth shares'), 0)

WebUI.verifyElementText(findTestObject('navigation/side-nav/Share schemes/Page_GS/h1_Growth shares'), 'Growth shares')

WebUI.verifyElementPresent(findTestObject('navigation/side-nav/Share schemes/Page_RSA/a_RSAs'), 0)

WebUI.verifyElementText(findTestObject('navigation/side-nav/Share schemes/Page_RSA/a_RSAs'), 'RSAs')

WebUI.click(findTestObject('navigation/side-nav/Share schemes/Page_RSA/a_RSAs'))

WebUI.verifyElementPresent(findTestObject('navigation/side-nav/Share schemes/Page_RSA/h1_RSAs'), 0)
...
WebUI.verifyElementPresent(findTestObject('navigation/side-nav/Share schemes/Page_Annual HMRC notifications/a_Annual notifications'), 
    0)

WebUI.verifyElementText(findTestObject('navigation/side-nav/Share schemes/Page_Annual HMRC notifications/a_Annual notifications'), 
    'Annual notifications')

WebUI.click(findTestObject('navigation/side-nav/Share schemes/Page_Annual HMRC notifications/a_Annual notifications'))

WebUI.verifyElementPresent(findTestObject('navigation/side-nav/Share schemes/Page_Annual HMRC notifications/h1_Annual notifications'), 
    0)

WebUI.verifyElementText(findTestObject('navigation/side-nav/Share schemes/Page_Annual HMRC notifications/h1_Annual notifications'), 
    'Annual notifications')
...
WebUI.verifyElementPresent(findTestObject('navigation/side-nav/Share schemes/Page_Initial-Notification/h1_EMI initial notifications to HMRC'), 
    0)

WebUI.verifyElementText(findTestObject('navigation/side-nav/Share schemes/Page_Initial-Notification/h1_EMI initial notifications to HMRC'), 
