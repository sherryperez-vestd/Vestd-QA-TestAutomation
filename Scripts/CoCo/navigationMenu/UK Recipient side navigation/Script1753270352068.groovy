...
WebUI.verifyElementPresent(findTestObject('CoCo/navigation/side-nav/PeopleAndCom/h1_Communication'), 0)

WebUI.verifyElementText(findTestObject('CoCo/navigation/side-nav/PeopleAndCom/h1_Communication'), 'Communication')
