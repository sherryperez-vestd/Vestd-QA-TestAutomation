...
WebUI.setText(findTestObject('SM/Page_403 - Vestd/input_Email address_email'), 'radhika.chaudhary@vestd.com')

WebUI.setEncryptedText(findTestObject('SM/Page_403 - Vestd/input_Password_password'), 'dKUWoKfqioauKpv97TPFcQ==')

WebUI.click(findTestObject('SM/Page_403 - Vestd/button_Log in'))
...
//subdivisionLabel.addProperty("xpath", ConditionType.EQUALS,
//	"//label[contains(., 'Subdivision needed')]")
