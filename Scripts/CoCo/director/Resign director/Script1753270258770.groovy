...
def resignDirector() {
    ...
    WebUI.setText(findTestObject('CoCo/CoSec/directors/input_ResignDay'), dateParts.day)
    WebUI.setText(findTestObject('CoCo/CoSec/directors/input_ResignMonth'), dateParts.month)
    WebUI.setText(findTestObject('CoCo/CoSec/directors/input_ResignYear'), dateParts.year)
...
def reappointDirector() {
    ...
    WebUI.setText(findTestObject('CoCo/CoSec/directors/input_appointedDay'), dateParts.day)
    WebUI.setText(findTestObject('CoCo/CoSec/directors/input_appointedMonth'), dateParts.month)
    WebUI.setText(findTestObject('CoCo/CoSec/directors/input_appointedYear'), dateParts.year)
