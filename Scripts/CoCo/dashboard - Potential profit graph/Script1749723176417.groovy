...
WebUI.callTestCase(findTestCase('Platform/usersLogin/UK/user-login-recipient2'), [:], FailureHandling.STOP_ON_FAILURE)
...
'Check Potential profit graph'
WebUI.verifyElementPresent(findTestObject('CoCo/dashboard/Page_Potential value profit/graph-canvas'), 0)
