...
WebUI.click(findTestObject('CoCo/navigation/side-nav/a_Share schemes'))
...
WebUI.verifyElementPresent(findTestObject('CoCo/navigation/side-nav/Share schemes/Page_RSA/a_RSAs'), 0)

WebUI.verifyElementText(findTestObject('CoCo/navigation/side-nav/Share schemes/Page_RSA/a_RSAs'), 'RSAs')

WebUI.click(findTestObject('CoCo/navigation/side-nav/Share schemes/Page_RSA/a_RSAs'))

WebUI.verifyElementPresent(findTestObject('CoCo/navigation/side-nav/Share schemes/Page_RSA/h1_RSAs'), 0)

WebUI.verifyElementText(findTestObject('CoCo/navigation/side-nav/Share schemes/Page_RSA/h1_RSAs'), 'RSAs')
...
WebUI.verifyElementPresent(findTestObject('CoCo/navigation/side-nav/Investment/Page_Investment-hub/h1_Investment - InVestd Raise'), 
    0)

WebUI.verifyElementText(findTestObject('CoCo/navigation/side-nav/Investment/Page_Investment-hub/h1_Investment - InVestd Raise'), 
...
WebUI.verifyElementText(findTestObject('CoCo/navigation/side-nav/Investment/Page_Guided-Flow/h1_Investment via InVestd - Invested Raise'), 'Investment via InVestd Raise')
