...
WebUI.callTestCase(findTestCase('Platform/usersLogin/UK/user-login-view-only'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementVisible(findTestObject('CoCo/navigation/side-nav/p_Vestd_Ltd_authorised_and_regulated_by'))
