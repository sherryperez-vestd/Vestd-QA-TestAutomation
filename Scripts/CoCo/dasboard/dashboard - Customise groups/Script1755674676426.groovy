...
WebUI.verifyElementVisible(findTestObject('Object Repository/CoCo/dashboard/Page_Group/button_New group'))

WebUI.verifyElementPresent(findTestObject('Object Repository/CoCo/dashboard/Page_Group/button_New group'), 0)

WebUI.verifyElementText(findTestObject('Object Repository/CoCo/dashboard/Page_Group/button_New group'), 'New group')

WebUI.click(findTestObject('Object Repository/CoCo/dashboard/Page_Group/button_New group'))

WebUI.setText(findTestObject('Object Repository/CoCo/dashboard/Page_Group - Create/input_Group name'), 'test')

WebUI.click(findTestObject('Object Repository/CoCo/dashboard/Page_Group - Create/span_Companies-selection'))

WebUI.click(findTestObject('Object Repository/CoCo/dashboard/Page_Group - Create/form_Group Companies Indian Co'))

WebUI.click(findTestObject('Object Repository/CoCo/dashboard/Page_Group - Create/input_Test Co_btn btn-primary'))

WebUI.verifyElementPresent(findTestObject('Object Repository/CoCo/dashboard/Page_Group/h5_test'), 0)

WebUI.verifyElementText(findTestObject('Object Repository/CoCo/dashboard/Page_Group/h5_test'), 'test')

WebUI.click(findTestObject('Object Repository/CoCo/dashboard/Page_Group/button_Delete'))
